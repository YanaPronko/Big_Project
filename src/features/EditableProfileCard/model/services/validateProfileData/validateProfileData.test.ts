...
describe("Test validateProfileData function", () => {
  ...
  test('should return  "incorrect user data"', () => {
    expect(validateProfileData({ ...profileData, lastname: "" })).toEqual([
      "incorrect user data",
    ]);
  });
  test('should return  "incorrect user data"', () => {
  ...
  test('should return  "incorrect age"', () => {
    expect(validateProfileData({ ...profileData, age: 0 })).toEqual([
      "incorrect age",
    ]);
  });
  test('should return  "incorrect country"', () => {
    expect(validateProfileData({ ...profileData, country: undefined })).toEqual(
      ["incorrect country"],
    );
  });
});
